...
class Euler11Spec extends FlatSpec with Matchers {
  ...
  "Euler 11" should "return the largest product of n adjacent numbers in the given grid" in {
    Euler11(4, grid) should be (70600674)
  }
